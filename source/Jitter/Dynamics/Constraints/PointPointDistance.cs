...
namespace Jitter.Dynamics.Constraints
{
    ...
    public class PointPointDistance : Constraint
    {
        ...
        public PointPointDistance(RigidBody body1, RigidBody body2, Vector3 anchor1,Vector3 anchor2)
            : base(body1, body2)
        {
            Vector3.Subtract(ref anchor1, ref body1.position, out localAnchor1);
            Vector3.Subtract(ref anchor2, ref body2.position, out localAnchor2);
        ...
        /// </summary>
        public Vector3 LocalAnchor1 { get { return localAnchor1; } set { localAnchor1 = value; } }

        /// <summary>
        /// The anchor point of body2 in local (body) coordinates.
        /// </summary>
        public Vector3 LocalAnchor2 { get { return localAnchor2; } set { localAnchor2 = value; } }
