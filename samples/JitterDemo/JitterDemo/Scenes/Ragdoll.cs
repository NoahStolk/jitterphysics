    ...
    class Ragdoll : Scene
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 3; i < 8; i++)
            {
                for (int e = 3; e < 8; e++)
                {
                    BuildRagdoll(Demo.World, new Vector3(i * 6 - 25, 5, e * 6 - 25));
                }
            }
        ...
        public void BuildRagdoll(World world, Vector3 position)
        {
            // the torso
            ...
            head.Position = position + new Vector3(0, 2.1f, 0);

            // connect head and torso
            PointPointDistance headTorso = new PointPointDistance(head, torso,
                position + new Vector3(0, 1.6f, 0), position + new Vector3(0, 1.5f, 0));

            RigidBody arm1 = new RigidBody(new CapsuleShape(0.8f, 0.2f));
            arm1.Position = position + new Vector3(1.0f, 0.75f, 0);

            RigidBody arm2 = new RigidBody(new CapsuleShape(0.8f, 0.2f));
            arm2.Position = position + new Vector3(-1.0f, 0.75f, 0);

            RigidBody lowerarm1 = new RigidBody(new CapsuleShape(0.6f, 0.2f));
            lowerarm1.Position = position + new Vector3(1.0f, -0.45f, 0);

            RigidBody lowerarm2 = new RigidBody(new CapsuleShape(0.6f, 0.2f));
            lowerarm2.Position = position + new Vector3(-1.0f, -0.45f, 0);

            PointOnPoint arm1torso = new PointOnPoint(arm1, torso, position + new Vector3(0.9f, 1.4f, 0));
            PointOnPoint arm2torso = new PointOnPoint(arm2, torso, position + new Vector3(-0.9f, 1.4f, 0));

            HingeJoint arm1Hinge = new HingeJoint(world, arm1, lowerarm1, position + new Vector3(1.0f, 0.05f, 0), Vector3.Right);
            HingeJoint arm2Hinge = new HingeJoint(world, arm2, lowerarm2, position + new Vector3(-1.0f, 0.05f, 0), Vector3.Right);

            RigidBody leg1 = new RigidBody(new CapsuleShape(1.0f, 0.3f));
            leg1.Position = position + new Vector3(-0.5f, -2.4f, 0);

            RigidBody leg2 = new RigidBody(new CapsuleShape(1.0f, 0.3f));
            leg2.Position = position + new Vector3(0.5f, -2.4f, 0);

            PointOnPoint leg1torso = new PointOnPoint(leg1, torso, position + new Vector3(-0.5f, -1.6f, 0));
            PointOnPoint leg2torso = new PointOnPoint(leg2, torso, position + new Vector3(+0.5f, -1.6f, 0));

            RigidBody lowerleg1 = new RigidBody(new CapsuleShape(0.8f, 0.3f));
            lowerleg1.Position = position + new Vector3(-0.5f, -4.0f, 0);

            RigidBody lowerleg2 = new RigidBody(new CapsuleShape(0.8f, 0.3f));
            lowerleg2.Position = position + new Vector3(+0.5f, -4.0f, 0);

            HingeJoint leg1Hinge = new HingeJoint(world, leg1, lowerleg1, position + new Vector3(-0.5f, -3.35f, 0), Vector3.Right);
            HingeJoint leg2Hinge = new HingeJoint(world, leg2, lowerleg2, position + new Vector3(0.5f, -3.35f, 0), Vector3.Right);
