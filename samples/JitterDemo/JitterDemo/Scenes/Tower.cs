...
namespace JitterDemo.Scenes
{
    class Tower : Scene
    {
        ...
        public override void Build()
        {
            ...
            //            b.Position = new Vector3(i, e, k) * 4.0f;
            ...
            //        RigidBody body = new RigidBody(shape);
            //        body.Orientation = Conversion.ToJitterMatrix(orientation);
            //        body.Position = Conversion.ToJitterVector(position) + new Vector3(20,0,0);
            ...
            //        RigidBody body = new RigidBody(shape);
            //        body.Orientation = Conversion.ToJitterMatrix(orientation);
            //        body.Position = Conversion.ToJitterVector(position) + new Vector3(00, 0, -20); ;
            ...
            //        RigidBody body = new RigidBody(shape);
            //        body.Orientation = Conversion.ToJitterMatrix(orientation);
            //        body.Position = Conversion.ToJitterVector(position) + new Vector3(20, 0, -20);
            ...
            //            body.Position = new Vector3(i, k, l) * 2.0f;
