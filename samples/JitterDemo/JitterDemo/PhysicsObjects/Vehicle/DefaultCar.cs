...
namespace JitterDemo
{
    ...
    public class DefaultCar : RigidBody
    {
        ...
        public DefaultCar(World world,Shape shape) : base(shape)
        {
            ...
            wheels[(int)WheelPosition.FrontLeft] = new Wheel(world, this, Vector3.Left + 1.8f * Vector3.Forward + 0.8f * Vector3.Down,0.4f);
            wheels[(int)WheelPosition.FrontRight] = new Wheel(world, this, Vector3.Right + 1.8f * Vector3.Forward + 0.8f * Vector3.Down, 0.4f);
            wheels[(int)WheelPosition.BackLeft] = new Wheel(world, this, Vector3.Left + 1.8f * Vector3.Backward + 0.8f * Vector3.Down, 0.4f);
            wheels[(int)WheelPosition.BackRight] = new Wheel(world, this, Vector3.Right + 1.8f * Vector3.Backward + 0.8f * Vector3.Down, 0.4f);
